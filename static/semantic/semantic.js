...
$.fn.form.settings = {
  ...
  templates: {
    ...
    // templates that produces error message
...
$.fn.search.settings = {
  ...
  // templates to use (specified in settings.templates)
  type              : 'standard',
  ...
  // field to display in standard results templates
  displayField   : '',
  ...
  error : {
    ...
    noTemplate      : 'A valid templates name was not specified.',
