...
from ..forms import AnimalForm, AnimalUpdateForm
...
def index_animal(request):
    ...
    if especie is not None:
        ...
        animais = AnimalModel.objects.order_by('nome_animal')
...
def update_animal(request, id):
    ...
    form = AnimalUpdateForm(request.POST or None, request.FILES or None, instance=animal)
