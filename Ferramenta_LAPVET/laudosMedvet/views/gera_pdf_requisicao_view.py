...
def gera_requisicao_pdf(request, id):
    ...
    texto = "<img src='static/image/ifc.png' width='10%' height='10%'/>" + \
            ...
            "Raça: " + requisicao.cod_animail.raca + "</div>"\
            + "<br>" + "<div style='float: left; width: 40%'>Data de nascimento: " + str(requisicao.cod_animail.data_nasc) + "</div>"\
            ...
            + requisicao.cod_animail.proprietario.rua.id_bairro.id_cidade.id_regiao_estado.id_estado.nome_estado\
