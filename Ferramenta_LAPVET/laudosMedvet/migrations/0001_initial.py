# Generated by Django 2.2.4 on 2019-10-21 17:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cidade', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.CidadeModel')),
                ('estado', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.EstadoModel')),
        ...
        migrations.AddField(
            ...
            name='id_estado',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.EstadoModel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='bairro',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.BairroModel'),
        ),
        migrations.AddField(
            model_name='animalmodel',
            name='cidade',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.CidadeModel'),
        ),
        migrations.AddField(
            model_name='animalmodel',
            name='id_especie',
        ...
        migrations.AddField(
            model_name='animalmodel',
            name='id_estado',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.EstadoModel'),
        ),
        migrations.AddField(
            model_name='animalmodel',
            name='proprietario',
        ...
        migrations.AddField(
            model_name='animalmodel',
            name='rua',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.RuaModel'),
        ),
        migrations.AddField(
            model_name='animalmodel',
            name='veterinario_responsavel',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.VeterinarioResponsavelModel'),
        ),
    ]
