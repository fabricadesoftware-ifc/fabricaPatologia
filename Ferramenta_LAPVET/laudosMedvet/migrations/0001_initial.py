# Generated by Django 2.2 on 2019-05-17 17:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.IntegerField()),
                ('especie', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.EspecieModel')),
                ('proprietario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.ProprietarioModel')),
                ('rua', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.RuaModel')),
                ('veterinario_responsavel', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='laudosMedvet.VeterinarioresponsavelModel')),
            ],
        ),
    ]
